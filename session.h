...
/**
 * @brief Saves the current looper session to a monolithic binary .qjams file.
...
/**
 * @brief Loads a looper session from a .qjams file, safely mapping it into the engine.
